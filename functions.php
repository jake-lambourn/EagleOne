...
function my_is_protected_meta_filter1($protected, $meta_key) {
    return $meta_key == 'detail-1780219293' ? true : $protected;
}

add_filter('is_protected_meta', 'my_is_protected_meta_filter1', 10, 2);
function my_is_protected_meta_filter2($protected, $meta_key) {
    return $meta_key == 'detail-1870782791' ? true : $protected;
}

add_filter('is_protected_meta', 'my_is_protected_meta_filter1', 10, 2);
function my_is_protected_meta_filter3($protected, $meta_key) {
    return $meta_key == 'detail-677927509' ? true : $protected;
}